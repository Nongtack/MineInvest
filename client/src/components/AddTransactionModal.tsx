...
export function AddTransactionModal({ isOpen, onClose, onAdd, symbols, initialData }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (assetType === 'stock' || assetType === 'crypto' || assetType === 'usStock') {
      ...
      tx.price = parseFloat(price) || 0; // Price per unit for funds
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {assetType === 'fund' ? (
              <>
                ...
                <div className="col-span-2 sm:col-span-1">
                  <label className="block text-xs font-semibold text-muted-foreground uppercase mb-1">ราคาต่อหน่วย (NAV)</label>
