  ...
  export function usePortfolio() {
    ...
    const computed = useMemo(() => {
      ...
      return {
        ...
        us: { mv: usMvThb, cost: usCostThb, pnl: usPnlThb, pct: usPct, div: usDivThb },
    ...
    return { state, computed, updateCryptoPrices, updateStockPrice, updateFundPrice, updateUsStockPrice, updateFxRate, addTransaction, deleteTransaction, undoLast, canUndo };
  }